# Whirlaway EVM Proof Serialization (v1/v2/v3)

This document defines Whirlaway EVM proof blob formats used by `evm_vectors`.
...
- Keep explicit legacy decode support for tests/fixtures.
...
- `v1`: `p3-whirlaway-evm-proof-v1`
- `v2`: `p3-whirlaway-evm-proof-v2`
- `v3`: `p3-whirlaway-evm-proof-v3`
...
### Transcript proof-data section

- `proof_data_len:varuint`
- `proof_data[i]:extension_field`
...
- `extension_field` (`BinomialExtensionField<_,8>`): 8 base limbs.
...
Whirlaway verification additionally rejects proofs where transcript `proof_data` is not fully consumed.
